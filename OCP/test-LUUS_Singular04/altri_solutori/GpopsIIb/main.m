...
bounds.phase(iphase).finaltime.lower    = 7;
...
bounds.phase(iphase).finalstate.lower   = [-inf -inf -inf -inf];
bounds.phase(iphase).finalstate.upper   = [inf inf inf inf];
...
fileID = fopen('gpops_sing04b.txt','w');
